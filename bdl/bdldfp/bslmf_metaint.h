...
struct MetaInt : public std::integral_constant<int, INT_VALUE> {
    ...
    MetaInt(std::integral_constant<int, INT_VALUE>);                // IMPLICIT
...
template <>
struct MetaInt<0> : public std::false_type {
    ...
    MetaInt(std::false_type);                                       // IMPLICIT
...
template <>
struct MetaInt<1> : public std::true_type {
    ...
    MetaInt(std::true_type);                                        // IMPLICIT
...
template <int INT_VALUE>
inline
MetaInt<INT_VALUE>::MetaInt(std::integral_constant<int, INT_VALUE>)
{
}
...
inline
MetaInt<0>::MetaInt(std::false_type)
{
}
...
inline
MetaInt<1>::MetaInt(std::true_type)
{
}
