...
class Printer {
    ...
    // DATA
    std::ostream *d_stream_p;                  // output stream (held, not
                                               // owned)
  ...
  public:
    // CREATORS
    Printer(std::ostream *stream, int level, int spacesPerLevel);
...
struct Printer_Helper {
    ...
    static void printRaw(std::ostream&                  stream,
                         char                           data,
                         int                            level,
                         int                            spacesPerLevel,
                         bslmf::SelectTraitCase<std::is_fundamental>);
    static void printRaw(std::ostream&                  stream,
                         bool                           data,
                         int                            level,
                         int                            spacesPerLevel,
    ...
    static void printRaw(std::ostream&                  stream,
                         ...
                         int                            level,
                         int                            spacesPerLevel,
                         bslmf::SelectTraitCase<std::is_enum>);
    ...
    static void printRaw(std::ostream&              stream,
                         ...
                         int                        level,
                         int                        spacesPerLevel,
                         bslmf::SelectTraitCase<std::is_pointer>);
    static void printRaw(std::ostream&              stream,
                         const void                *data,
                         int                        level,
                         int                        spacesPerLevel,
    ...
    static void printRaw(std::ostream&              stream,
                         ...
                         int                        level,
                         int                        spacesPerLevel,
                         bslmf::SelectTraitCase<std::is_array>);
...
template <class ITERATOR>
inline
void Printer_Helper::print(std::ostream&   stream,
                           const ITERATOR& begin,
                           const ITERATOR& end,
                           const int       level,
...
template <class TYPE>
inline
void Printer_Helper::printRaw(std::ostream&                  stream,
                              TYPE                           data,
                              int                            ,
                              int                            spacesPerLevel,
                              bslmf::SelectTraitCase<std::is_fundamental>)
