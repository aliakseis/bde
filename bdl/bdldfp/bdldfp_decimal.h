...
void hashAppend(HASHALG& hashAlg, const bdldfp::Decimal32& object)
{
...
template <class HASHALG>
void hashAppend(HASHALG& hashAlg, const bdldfp::Decimal64& object)
{
    using ::BloombergLP::bslh::hashAppend;
...
template <class HASHALG>
void hashAppend(HASHALG& hashAlg, const bdldfp::Decimal128& object)
{
    using ::BloombergLP::bslh::hashAppend;
